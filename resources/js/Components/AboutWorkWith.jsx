...
export const AboutWorkWith = ({ content }) => {
    ...
    return (
        <section ref={sectionRef} className="relative pt-10 mb-20 md:mb-30">
            <div className="relative pt-16 pb-14 bg-primary">
                <div className="container max-w-large">
                    <LetterReveal
                        className="font-secondary text-white font-black uppercase mb-1"
                        text="Trabalhe Conosco"
                        element="h4"
                    />
                    <LetterReveal
                        className="font-secondary text-white text-6xl font-black leading-none uppercase"
                        text={content.titulo}
                        element="h2"
                    />
                    <LetterReveal
                        className="font-secondary text-secondary text-6xl font-black leading-none uppercase"
                ...
                <img
                    ...
                    className="absolute -top-36 -right-10 w-[30em] drop-shadow-2xl"
                />
            </div>

            <div className="container max-w-large">
                <div className="mt-16 mb-20 text-3xl 2xl:text-[38px] leading-tight">
                    ...
                    <div className="mb-3 md:mb-5 min-[1440px]:mb-4 flex gap-3 md:gap-5 lg:gap-6 flex-col lg:flex-row">
                        <div className="w-full lg:w-1/2">
                            ...
                            <input
                                ...
                                className="w-full h-12 px-0 2xl:text-xl border-0 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-b-secondary focus:shadow-inner transition-colors duration-200 placeholder:text-gray-500 placeholder:text-opacity-70"
                            />
                            {errors.nome && (
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    value={data.area}
                                    onChange={handleChange}
                                    className="w-full h-12 px-0 2xl:text-xl border-0 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-b-secondary focus:shadow-inner transition-colors duration-200"
                                >
                            ...
                            <label className="flex items-center cursor-pointer">
                                <span className="bg-primary text-white rounded-full p-2.5">
                                    <svg
                                        ...
                                        width="20"
                                        height="20"
                                        viewBox="0 0 30.834 35.251"
                                    >
                                        <path
                                            id="Caminho_205"
                                            data-name="Caminho 205"
                                            d="M9.158.03a10.178,10.178,0,0,1,7.261,2.332l9.452,9.446a1.218,1.218,0,0,1-1.741,1.666C21.006,10.66,18.2,7.164,15.057,4.408,7.9-1.875-1.963,7.836,4.465,15.152L20.9,31.58a4.418,4.418,0,0,0,6.687-5.7C22.226,20.305,16.739,14.795,11.152,9.452a1.618,1.618,0,0,0-2.146,2.222L19.914,22.624a1.24,1.24,0,1,1-1.595,1.9L7.577,13.785A4.055,4.055,0,0,1,13.2,7.937L28.985,23.724a6.857,6.857,0,0,1-9.1,10.166L2.567,16.669A10,10,0,0,1,9.158.03Z"
                                ...
                                <span className="ml-2">
                                    {data.curriculo ? data.curriculo.name : "Nenhum arquivo selecionado"}
                                </span>
                                <input
                                    type="file"
                                    name="curriculo"
                    ...
                    <div className="mb-5 md:mb-8 min-[1440px]:mb-10 flex gap-3 md:gap-5 lg:gap-6 flex-col lg:flex-row">
                        <div className="w-full">
                            ...
                            <textarea
                                ...
                                className="w-full h-40 2xl:h-48 resize-none px-0 2xl:text-xl border-0 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-b-secondary focus:shadow-inner transition-colors duration-200 placeholder:text-gray-500 placeholder:text-opacity-70"
                            />
                            {errors.mensagem && (
                                <p className="text-xs text-white bg-red-900 px-3 py-1.5 mt-2">
                                    {errors.mensagem}
