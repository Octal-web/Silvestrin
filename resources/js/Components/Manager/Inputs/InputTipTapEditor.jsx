        ...
        <div className="mb-6">
            ...
            <div className="border rounded-lg">
                ...
                <div className="p-3 min-h-40 overflow-auto max-h-screen">
                    <EditorContent
                        editor={editor}
                        className="[&_.ProseMirror]:min-h-30 [&_p]:text-sm [&_h1]:text-4xl [&_h2]:text-3xl [&_h3]:text-2xl [&_h4]:text-xl [&_h5]:text-base [&_th]:border [&_td]:border [&_ul]:list-inside [&_li]:list-disc [&_ul>li>p]:contents [&_a]:underline [&_a]:text-blue-500 [&_.ProseMirror-focused]:outline-none"
                    />
                </div>
            </div>
        </div>
