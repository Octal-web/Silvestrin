...
export const ProductsList = ({
    ...
    return (
        <section
            className={`pt-1 pb-10 -mt-80 lg:mt-8 xl:mt-10 2xl:pb-24 ${hasAside ? "flex-1" : "w-full"}`}
        >
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {produtos && produtos.length > 0 ? (
                            <div className="grid grid-cols-2 2xl:grid-cols-3 gap-3 md:gap-8 lg:ml-12">
                                {currentItems.map((produto) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative aspect-square bg-white px-4 md:px-12 pt-16 lg:pt-24 lg:pb-4 max-h-72 lg:max-h-80">
                                            {produto.imagem ? (
                                                <img
                                                    src={produto.imagem}
                                                    alt={produto.nome}
                                            ...
                                            {produto.sazonalidade.length > 0 && (
                                                <>
                                                    ...
                                                    <div className="flex flex-wrap mt-3 gap-0.5">
                                                        {produto.sazonalidade.map((item, index) => (
                                                            <span
                                                                key={index}
                                                                className="size-5 lg:size-[1.5em] text-xs lg:text-sm text-gray-400 flex items-center justify-center border border-gray-400"
                                                            >
                                                                {item}
                                                            </span>
                                                        ))}
