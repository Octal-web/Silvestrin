...
export const AboutRain = ({ content }) => {
    ...
    return (
        <section ref={sectionRef} className="relative pb-16 md:py-16 xl:py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">                    
                    ...
                    <Reveal direction="left" className="">
                        <div className="ml-auto max-w-[772px] mt-8">
                            <LetterReveal className="font-secondary text-primary text-5xl font-black leading-tight uppercase max-w-[32rem]" text={content.titulo} element="h2" />
            ...
            <img ref={imageRef} src={content.imagem_mobile} alt={content.titulo} className="absolute -top-30 -right-40 w-[30em] drop-shadow-2xl" />
        </section>
    );
};
