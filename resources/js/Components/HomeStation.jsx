...
export const HomeStation = ({ content }) => {
    ...
    return (
        <section ref={sectionRef} className="relative pb-16 md:py-16 xl:py-24">
            <div className="relative container max-w-large">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <Reveal direction="right">
                        <div className="-ml-10 -translate-x-20 -mt-[30%]">
            ...
            <img ref={imageRef} src={content.imagem_mobile} alt={content.titulo} className="absolute -bottom-20 right-0 w-[30em] drop-shadow-2xl" />
        </section>
    );
};
