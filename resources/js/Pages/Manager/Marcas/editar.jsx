...
const Page = () => {
    const { idioma, idiomas, marca } = usePage().props;

    const { data, setData, post, errors } = useForm(marca);
    ...
    const breadcrumbItems = [
        ...
        { label: "Categorias", link: "Manager.Categorias.index" },
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(
            route("Manager.Marcas.atualizar", {
                id: marca.id,
                lang: idioma_url,
            }),
            {
                ...
                <div className="mt-10">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <Link
                                href={route("Manager.Categorias.index")}
