            ...
            <div className="mb-6 rounded-sm border border-stroke bg-white px-5 py-5 shadow-md">
                ...
                <div className="mt-10">
                    <div className="flex flex-col gap-y-2">
                        ...
                        <p className="capitalize">
                            <b>Área</b>:{" "}
                            {contato.area === "comercial"
                                ? "Comercial"
                                : "Trabalhe conosco"}
                        </p>
                        <p>
                            <b>Mensagem</b>: <br /> {contato.mensagem}
                        </p>
                        <p>
                            <b>Data</b>: {contato.data}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-end">
                    <Link
                        ...
                        className="block relative w-fit rounded-lg border mr-3 border-gray-300 px-3 py-2 cursor-pointer transition-all hover:bg-slate-200"
                    >
                ...
                {isModalOpen && (
                    <ConfirmModal
                        ...
                        type="delete"
                        confirm={route("Manager.Contato.excluir", {
                            id: contato.id,
                        })}
                    />
                )}
