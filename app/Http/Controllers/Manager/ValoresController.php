...
class ValoresController extends Controller
{
    ...
    {
        return Inertia::render('Manager/Valores/adicionar');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function novo(ValorRequest $request)
    {
        if ($request->ajax()) {
            ...
            $response = $this->service->cadastrarValor($idioma, $request);
    ...
    public function editar($id)
    {
        ...
        [$valorData, $idioma, $idiomas] = $this->service->editarValor($id);

        return Inertia::render('Manager/Valores/editar', [
            'idiomas' => $idiomas,
            'idioma' => $idioma,
            'valor' => $valorData
        ]);
     ...
     * @return \Illuminate\Http\Response
     */
    public function atualizar(ValorRequest $request, $id)
    {
        if ($request->ajax()) {
            $response = $this->service->atualizarValor($request, $id);
